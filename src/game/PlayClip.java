 ...
 * 
 * Comments:
 * PlayClip class was reused from CS3230 Mahjong Game with Dr. Brinkerhoff.
 * It is responsible for playing the game's sounds.
 */
...
public class PlayClip implements LineListener
{
	...
	public static void main(String[] args)
	{
		try
		{
			PlayClip clip = new PlayClip("sounds/SnakeSong.wav", true);
